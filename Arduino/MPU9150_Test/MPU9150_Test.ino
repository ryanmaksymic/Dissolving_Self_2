/*
 ...
 Playing with the MPU-9150 chip.
...
void setup()
{
  ...
  //  display.print("MPU9150");
  //  display.setTextSize(1);
  //  display.setCursor(0, 20); 
  //  display.print("9 DOF sensor");
  //  display.setCursor(0, 30); 
  //  display.print("data fusion");
...
void loop()
{
  ...
  if (delt_t > 500)    // update LCD once per half-second independent of read rate
  {
    ...
    Serial.print("rate = "); 
    Serial.print((float)1.0f/deltat, 2); 
    Serial.println(" Hz");
