/*
 ...
 This is a modified version of the file Somo_Base.
...
{
  Wire.begin();
  Serial.begin(38400);    // REM - Original: 38400
  ...
  // REM - Commented out to avoid waiting on Max connection:
  /*
...
void loop() {
  ...
  // REM - Let's only print one value:
  ...
  // REM - The following line sends encoded stuff for Max to decode; not good:
